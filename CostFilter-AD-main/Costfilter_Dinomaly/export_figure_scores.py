#!/usr/bin/env python3
# Run examples:
#   python export_figure_scores.py --dataset psma --modality petct --gpu 4 --test_stage costfilter --skip_existing --skip_require_pixel
#   python export_figure_scores.py --dataset fdg --modality petct --gpu 4 --test_stage costfilter --skip_existing --skip_require_pixel
