...
#
#         # ========== 核心修改：查找以 _gt.png 和 _pred.png 结尾的文件 ==========
#         pred_file = None
#         gt_file = None
#
#         # 遍历子文件夹内的所有文件
...
#                 pred_file = file_name
#             elif file_name.endswith("_gt.png"):
#                 gt_file = file_name
#
#         # 检查是否找到对应的文件
#         if pred_file is None:
#             print(f"Warning: No file ending with _pred.png found in {folder_path}")
#             continue
#         if gt_file is None:
#             print(f"Warning: No file ending with _gt.png found in {folder_path}")
#             continue
#
#         # 拼接完整文件路径
...
#             print(f"Error reading images in {folder_path} (pred: {pred_file}, gt: {gt_file})")
#             continue
#
...
#         description="Calculate SSIM from subfolders (files ending with _gt.png & _pred.png)")
#     # 更新参数说明，匹配新的文件命名规则
#     parser.add_argument("--root_dir", type=str, required=True,
#                         help="Root directory containing subfolders with files ending with _gt.png and _pred.png")
