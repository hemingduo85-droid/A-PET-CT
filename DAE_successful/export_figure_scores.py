...
def main():
    ...
    if args.output_dir is None:
        args.output_dir = str(resolve_project_path(args.checkpoint_dir) / args.tracer / "_".join(modalities) / "figure_scores")
    ...
    manifest = write_outputs(rows, pixel_rows, output_dir, {
        ...
        "inference_rule": "denoising wrapper forward with configured Gaussian noise, matching train.py evaluate()",
    })
