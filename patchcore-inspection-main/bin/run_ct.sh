#!/usr/bin/env bash
# Run PatchCore with single-modal CT input on the AutoPET/PSMA dataset.
#
# Usage:
#   bash bin/run_ct.sh [gpu_id] [seed]
#
# Examples:
#   bash bin/run_ct.sh 0 0   # GPU 0, seed 0
#   bash bin/run_ct.sh 1 42  # GPU 1, seed 42
#
# The script must be run from the repository root, e.g.:
#   cd /data/cyf/codes/A-PET-CT/patchcore-inspection-main
#   bash bin/run_ct.sh 0 0
...
LOG_GROUP=CT_PSMA_IM256_WR50_L2-3_P01_D1024-1024_PS3_AN1_SingleModal_S${SEED}
LOG_PROJECT=PetCT_Results

echo "=========================================="
echo " PatchCore  — Single-Modal CT"
