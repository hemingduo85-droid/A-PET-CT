#!/usr/bin/env python3
# Run examples:
#   python export_figure_scores.py --dataset psma --input_mode dual --devices 6 --skip_existing --skip_require_pixel
#   python export_figure_scores.py --dataset fdg --input_mode dual --devices 6 --skip_existing --skip_require_pixel
...
def main():
    ...
    output_dir = args.output_dir or os.path.join(args.save_dir, "figure_scores")
    ...
    outputs = write_exports(
        ...
        pixel_rows,
        {
            "repo": "InversionAD1",
            "config": args.fname,
            "dataset": config["data"].get("petct_dataset"),
