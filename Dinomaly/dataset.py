...
class PetCTDataset(torch.utils.data.Dataset):
    ...
    Supports three input modes:
      - 'ct':   grayscale CT → [CT, CT, CT] pseudo-RGB
      - 'pet':  grayscale PET → [PET, PET, PET] pseudo-RGB
      - 'dual': [CT, PET, PET] pseudo-RGB
    """
    ...
    def __getitem__(self, idx):
        ...
        img = self._load_image(ct_path, pet_path)
        img = self.transform(img)
        ...
        return img, gt, label, str(ct_path)
