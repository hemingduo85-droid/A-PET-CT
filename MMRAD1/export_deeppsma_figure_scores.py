#!/usr/bin/env python3
"""DeepPSMA generalization commands (MMRAD):
python export_deeppsma_figure_scores.py --source_dataset PSMA --data_root /data/cyf/shared_data/A-PETCT/2d_equal_mask50/deeppsma1 --modalities ct,pet --checkpoint /data/cyf/codes/A-PET-CT/MMRAD1/checkpoints/PSMA/ct_pet/model.pth --device cuda:4 --output_dir generalization_outputs/PSMA_weights/figure_scores --skip_existing --skip_require_pixel

python export_deeppsma_figure_scores.py --source_dataset FDG --data_root /data/cyf/shared_data/A-PETCT/2d_equal_mask50/deeppsma1 --modalities ct,pet --checkpoint /data/cyf/codes/A-PET-CT/MMRAD1/checkpoints/FDG/ct_pet/model.pth --device cuda:5 --output_dir generalization_outputs/FDG_weights/figure_scores --skip_existing --skip_require_pixel
"""
"""
Run examples:
  python export_deeppsma_figure_scores.py --data_root /data/cyf/shared_data/A-PETCT/2d_equal_mask50 --tracer PSMA \
    --modalities ct,pet --checkpoint /data/cyf/codes/A-PET-CT/MMRAD1/checkpoints/PSMA/ct_pet/model.pth \
    --device cuda:4 --skip_existing --skip_require_pixel
  python export_deeppsma_figure_scores.py --data_root /data/cyf/shared_data/A-PETCT/2d_equal_mask50 --tracer FDG \
    --modalities ct,pet --checkpoint /data/cyf/codes/A-PET-CT/MMRAD1/checkpoints/FDG/ct_pet/model.pth \
    --device cuda:5 --skip_existing --skip_require_pixel
